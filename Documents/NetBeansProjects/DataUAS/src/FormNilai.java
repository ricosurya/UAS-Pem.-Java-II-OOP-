...
public class FormNilai extends javax.swing.JFrame {
    ...
    public FormNilai() {
     ...
     public void selectData() {
        ...
        String  SQL  = "SELECT * FROM nilai2 where nama ='"+nama.getText()+"' && nama_mk LIKE'%"+matkul.getText()+"%'";
        ResultSet rs = KonekDatabase.executeQuery(SQL);
        try {
            while(rs.next()) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(nama)
                    .addComponent(matkul)
                    .addComponent(cek, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
